...
The <a href="/property-api-reference/policies/cancellation-status" target="_blank">Cancellation Status API</a> gets you an updated status of your policy. Yasmina makes a call to the insurance provider to inquire about the policy, and will return a response with updated status.
