...
## Introduction
This guide describes Yasmina’s Motor Insurance APIs for Multiple Insurance Providers (for single insurance provider, [click here](/integrations/car)). These APIs cover all essential operations for Comprehensive motor insurance — including requesting quotes, issuing and managing policies, generating payment links, and handling claims.
