...
The customer should then get an OTP. The API itself will simply return 204 No Content.
...
| ----------------------- | --------------------- | ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `otp`                   | `123456`              | Yes               | The OTP received by the customer from the Request OTP API.                                                                                                                  |
...
| `car_sequence_number`   | `52423810`            | Yes               | The car’s sequence number (8–9 digits). Use this OR `custom_number` — one is required.                                                                                      |
| `custom_number`         | `1234567890`       | Yes               | Custom car number for newly imported cars. Use this OR `car_sequence_number` — one is required.                                                            |
...
| Field                | Example Value | Is Required | Description                                                                                                                          |
| -------------------- | ------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `owner_id`           | `2234567890`  | Yes         | Driver's national ID. Must be 10 digits and starts with 1, 2, or 7.                                                                  |
