...
<Update label="24th December 2025" tags={["Docs", "APIs"]}>
	Add driver details to Car Insurance Quote Requests
	* Added drivers array to quote request body with validation rules
	* Driver fields: owner_id, birthdate, driving_percentage
	* Driving percentages must sum to 100, owner must be included
</Update>
