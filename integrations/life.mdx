...
<Steps>
	...
	Or go directly to [Authorization API](/car-api-reference/auth/generate-token)
	  ...
	  <Step title="Issue policies for your customers">
      	...
      	Or go directly to [Issue policies API](/car-api-reference/policies/request-policy)
      </Step>
</Steps>
...
### Issue policies
To issue policies, you need to execute the [Issue policies API](/car-api-reference/policies/request-policy)).