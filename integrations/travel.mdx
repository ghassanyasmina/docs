...
In order to Issue a policy, you need to execute the <a href="/yasmina-schengen-travel-insurance/policies/purchase" target="_blank">Purchase Policy API</a>
