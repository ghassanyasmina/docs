...
<Steps>
  <Step title="Authorization">
  	...
  	Or go directly to <a href="/auth-api-reference/oauth-20/generate-token" target="_blank">Authorization API</a>
  </Step>
  <Step title="Create a company">
  	...
  	Or go directly to <a href="/medical-api-reference/company/create-company" target="_blank">Create company API</a>
  </Step>
  <Step title="Choose a package">
  	...
  	Or go directly to <a href="/medical-api-reference/products/list-categories" target="_blank">List categories</a>
  </Step>
  <Step title="Issue insurance for the employees">
  	Select the employees of the company that are going to get insurances and pick a package for each. [Click for more details](#issue-insurance-policies).

  	Or go directly to <a href="/medical-api-reference/policies/issue-policies" target="_blank">Issue policies API</a>
  </Step>
  <Step title="Health declaration">
  	...
  	Or go directly to <a href="/medical-api-reference/hr-forms/dispatch-hr-forms" target="_blank">Dispatch Medical Forms API</a>
  </Step>
  <Step title="Payment">
