...
```
          ...
          <p class="yasmina-try-footnote">This endpoint sends an OTP to the provided phone number.</p>
        </div>
        <div
          class="yasmina-try-panel"
          ...
          data-try-id="request"
        >
          <h3>Request multi-provider quotes</h3>
          <CodeGroup>
```bash cURL expandable=true
...
```
          ...
          <p class="yasmina-try-footnote">Use the OTP and customer data from the previous step to retrieve prices from multiple insurers.</p>
        </div>
        <div
          class="yasmina-try-panel"
        ...
        >
          <h3>Request a policy issue OTP</h3>
          <CodeGroup>
```bash cURL expandable=true
...
```
          ...
          <p class="yasmina-try-footnote">Trigger an OTP confirmation to authorize issuance before moving forward.</p>
        </div>
        <div
          class="yasmina-try-panel"
          ...
          data-try-id="policy"
        >
          <h3>Generate a policy and payment link</h3>
          <CodeGroup>
```bash cURL expandable=true
...
```
          ...
          <p class="yasmina-try-footnote">The response returns a policy draft and `payment_link` you can surface to the customer.</p>
        </div>
      </div>
    </div>
  </div>
