...
<Steps>
  ...
  <Step icon="clipboard-list" title="Enrollment process">
	  <Note>The enrollment process is only required for Live environment. Sandbox environment doesn't require it.</Note>
...
<Tip>Made a mistake or missed something? You can reset your submission and update the details anytime.</Tip>
