...
<Steps>
	...
	Or go directly to <a href="/auth-api-reference/oauth-20/generate-token" target="_blank">Generate Token API</a>
	</Step>
	  <Step title="Issue policies for your customers">
      	...
      	Or go directly to <a target="_blank" href="/life-snp/policies/issue-policy">Issue policies API</a>
      </Step>
</Steps>
...
Go to the following link to use the <a href="/auth-api-reference/oauth-20/generate-token" target="_blank">Generate Token API</a>.

<Warning>For security reasons. Do not make your client_id and client_secret public in your platform.</Warning>

### Issue policies
To issue policies, you need to execute the <a target="_blank" href="/life-snp/policies/issue-policy">Issue policies API</a>.